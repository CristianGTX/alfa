...
lgSize:3},{minInt:1,minFrac:2,maxFrac:2,posPre:"\u00a4",posSuf:"",negPre:"(\u00a4",negSuf:")",gSize:3,lgSize:3}],CURRENCY_SYM:"$"},DATETIME_FORMATS:{MONTH:"Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(" "),SHORTMONTH:"Ene Feb Mar Abr May Jun Jul Ago Sep Oct Nov Dic".split(" "),DAY:"Domingo Lunes Martes Miercoles Jueves Viernes Sabado".split(" "),SHORTDAY:"Dom Lun Mar Mie Jue Vie Sab".split(" "),AMPMS:["AM","PM"],medium:"MMM d, y h:mm:ss a","short":"M/d/yy h:mm a",
